...
#' 
#' Checks if hole is part of polygon or not. Used by \code{\link{spToGeoJSON}}.
#' 
#' 
#' @param polyCoord Polygon coordinates as data.frame.
#' @param holeCoord Hole coordinates as data.frame.
#' @return Boolean
